...
namespace Drupal\commerce_order_info\Plugin\Commerce\CheckoutPane;
...
/**
 * Provides the Order summary complete pane.
 *
 * @CommerceCheckoutPane(
 *   id = "order_summary_complete",
 *   label = @Translation("Order summary complete"),
 *   default_step = "complete",
 *   wrapper_element = "container",
 * )
 */
class OrderSummaryComplete extends CheckoutPaneBase implements CheckoutPaneInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($view_storage->loadMultiple() as $view) {
      if (strpos($view->get('tag'), 'commerce_order_summary_complete') !== FALSE) {
    ...
    $form['view'] = [
      ...
      '#states' => [
        'visible' => [
          ':input[name="configuration[panes][order_summary_complete][configuration][use_view]"]' => ['checked' => TRUE],
        ],
      ],
    ];
